<?php
	...
	*/
	...
	//define("DOMAIN", $_SERVER['HTTPS_HOST']);
	define("DOMAIN", 'demo4.iftgift.com');
	define ('SiteFolder' , '');
	
	//define("ruadmin","http://".$_SERVER['HTTPS_HOST']."/". SiteFolder ."iftgift_cpanel/");
	define("ruadmin","https://demo4.iftgift.com/". SiteFolder ."iftgift_cpanel/");

	define("ru", "https://".DOMAIN."/" . SiteFolder);
	...
	define("ru_dir", 	"/home1/flashbag/public_html/demo4/" . SiteFolder);
...
/****************Live_ demo_3********************/
	...
	define("ACSQL_DB_NAME", 'flashbag_iftgift4');			// <-- mysql db name
...
function sendmail($to,  $subject, $message,$headers){
		...
		$mail->Host 		= 'gator4041.hostgator.com';
		$mail->Port 		= '465'; 
		$mail->Username 	= 'info@iftgift.com';  
		$mail->Password 	= 'iftGiftxx22'; 	

		//print_r($mail);
		$mail->SetFrom('info@iftgift.com','Iftgift');	

		$mail->AddReplyTo('info@iftgift.com','Iftgift');	
